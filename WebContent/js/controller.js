$(document).ready(function() { 
	...
	$('#allInput').submit(function(e) {
		...
		var url = "https://assignment-cloud-11020639.azurewebsites.net/Films?action=getAllFilms&format="+format
	...
	$('#searchInput').submit(function(e) {
		...
		var url = "https://assignment-cloud-11020639.azurewebsites.net/Films?action=getFilm&search="+search+"&format="+format
	...
	$('#addInput').submit(function(e) {
		...
		if( format=="json" ){
			...
			$.ajax({
			    type: "POST",
			    url: "https://assignment-cloud-11020639.azurewebsites.net/Films",
